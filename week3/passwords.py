...
#
# Complete the code below to produce a recursive function passwords.py(n) that would produce a set of all words in letters A and B with n letters.
#
# F​or example passwords.py(2) should return {"AA", "AB", "BA", "BB"}.
